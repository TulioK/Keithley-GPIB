...
# The original location and name of the script was /home/bashiri/cviv/c/scripts/plot_cv.py.
# LIP-PPS-Run-Manager v 0.3.0 was used as the managing backend.
# The backup was created on 2023-12-04 11:40:49.091081.
# A copy of all the local variables at the time the __enter__ method of the task started:
#   Pedro: RunManager(PosixPath('/home/bashiri/cviv/c/scripts/data/CVIV-Run0183'))
#   db_path: PosixPath('/home/bashiri/cviv/c/scripts/data/run_db.sqlite')
#   logger: <Logger plot_cv (WARNING)>
#   font_size: 18
#   sql_conn: <sqlite3.Connection object at 0x7f6f70be2f40>
#   run_name: 'CVIV-Run0183'
#   run_info_sql: "SELECT `RunName`,`type` FROM 'RunInfo' WHERE `RunName`=?;"
#   res: [('CVIV-Run0183', 2)]
#   run_type: <CVIV_Types.CV: 2>
# ------------------------------------------------------------------------------------------------
#############################################################################
# zlib License
#
