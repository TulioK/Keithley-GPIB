...
# The backup was created on 2023-12-04 11:40:58.696703.
# A copy of all the local variables at the time the __enter__ method of the task started:
#   Pedro: RunManager(PosixPath('/home/bashiri/cviv/c/scripts/data/CVIV-Run0187'))
#   db_path: PosixPath('/home/bashiri/cviv/c/scripts/data/run_db.sqlite')
#   logger: <Logger plot_cv (WARNING)>
#   font_size: 18
#   sql_conn: <sqlite3.Connection object at 0x7f6f6cbb0040>
#   run_name: 'CVIV-Run0187'
