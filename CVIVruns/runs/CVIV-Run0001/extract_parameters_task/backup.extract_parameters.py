...
# The original location and name of the script was /home/bashiri/cviv/c/scripts/extract_parameters.py.
# LIP-PPS-Run-Manager v 0.3.0 was used as the managing backend.
# The backup was created on 2023-12-04 11:34:54.800954.
# A copy of all the local variables at the time the __enter__ method of the task started:
#   Joana: RunManager(PosixPath('/home/bashiri/cviv/c/scripts/data/CVIV-Run0001'))
